...
// Fonction pour construire le graphe à partir de la description de la fourmilière un
...
// Fonction pour simuler les étapes de déplacement des fourmis pour la fourmilière un
